...
bool FakePkgManager::ShellCorePatch()
{
    ...
    if (s_Ret < 0)
    {
	  ...
	  s_Ret = Utilities::ProcessReadWriteMemory(s_Process, (void*)(s_TextStart + ssc_sys_dynlib_dlsym_patch), 8, (void*)"\x8B\x48\x90\x00\x00\x01\xC1\xE9", nullptr, true);
    if (s_Ret < 0)
      {
...
=======
>>>>>>> 165daa3e1fb56833761b674215786954c1502eee
